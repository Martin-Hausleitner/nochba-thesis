...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{pics/range-filter.JPG}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth]{pics/public-profile.JPG}
  \caption{Öffentliches Profil auf der App}
  \label{fig:einladecode}
\end{figure}
