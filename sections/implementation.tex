...
Schließlich werden die Informationen des Benutzers und des Verifizierungscodes in der Datenbank aktualisiert, um anzuzeigen, dass der Benutzer erfolgreich verifiziert wurde. Die Cloud-Function gibt true zurück, um anzuzeigen, dass die Verifizierung erfolgreich war.

\subsubsection{Regestrierung mit Gerät Koordinaten}
Die Funktion "checkAddressWithDeviceLocation" erfordert eine authentifizierte Anfrage und
