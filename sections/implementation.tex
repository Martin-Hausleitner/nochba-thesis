...
\textbf{openai_client: ^0.0.7} - Dieses Paket ermöglicht die Nutzung von OpenAI-Diensten in der Applikation, wodurch die Integration von künstlicher Intelligenz und maschinellem Lernen unterstützt wird.
...
\textbf{flutter_map: ^3.1.0} - Dieses Paket ermöglicht die Integration von interaktiven Karten in der Applikation.
...
\textbf{mobile_scanner: ^3.0.0} - Dieses Paket ermöglicht die Integration von Scanner-Funktionalitäten für mobile Geräte in der Applikation und unterstützt das Scannen von Barcodes, QR-Codes und Dokumenten.
...
\textbf{cupertino_icons: ^1.0.5} - Dieses Paket stellt eine Sammlung von über 1.000 hochwertigen iOS-Stil-Icons (Cupertino) für die Verwendung in der Applikation zur Verfügung.
