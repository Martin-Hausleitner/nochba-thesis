...
\paragraph{Github Action}\leavevmode
...
\paragraph{Firebase App Distribution}\leavevmode
...
\paragraph{Apple Developer Lizenz}\leavevmode
...
\paragraph{Google Barcode-Scanning ML Kit}\leavevmode
\setauthor{Martin Hausleitner}
...
\setauthor{Martin Hausleitner}
\paragraph{GPT-3.5-turbo}\leavevmode
...
\paragraph{Google Translation ML Kit}\leavevmode
...
\paragraph{Google Language identification ML Kit}\leavevmode
...
\subsubsection{Farben}\leavevmode
...
\paragraph{Logo Historie}\leavevmode
% \hspace*{\parindent}
...
\paragraph{Notifications}\leavevmode
...
\paragraph{Likes von Beiträge erhöhen}\leavevmode
\setauthor{Sandin Habibovic}
...
\paragraph{Likes von Beiträge verringern}\leavevmode
\setauthor{Sandin Habibovic}
...
\paragraph{Likes von Kommentare erhöhen}\leavevmode
\setauthor{Sandin Habibovic}
...
\paragraph{Likes von Kommentare verringern}\leavevmode
\setauthor{Sandin Habibovic}
